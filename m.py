...
bot = telebot.TeleBot('7405385540:AAE2RnzQWmvD3JGf5Q_-yD6J9Emd8xRYqg0')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @VIPxMODS")
...
Buy From :- @VIPxMODS
Official Channel :- https://t.me/+H9uesF_wPM9iYjZl
'''
